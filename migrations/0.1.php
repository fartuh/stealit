...
$stmt = $pdo->prepare("CREATE TABLE users(id INT NOT NULL AUTO_INCREMENT, login VARCHAR(40) UNIQUE, pass varchar(40), nic varchar(40) UNIQUE, vk varchar(30), skype varchar(20), secret VARCHAR(40), PRIMARY KEY(id))");
